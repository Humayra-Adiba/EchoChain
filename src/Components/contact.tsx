...
const Contact = () => {
  ...
  const isActive = (parson: IParson) =>
    activePerson.some((p) => p.id === parson.id);
  ...
  return (
    <div className="w-full max-w-[516px] relative flex flex-col justify-center items-center">
      <h2 className="font-semibold md:text-[29px] text-[25px] md:leading-[39.06px] leading-[28px] tracking-[-2%] bg-gradient-to-r from-blue-500  to-pink-700 text-transparent bg-clip-text py-3 ">
